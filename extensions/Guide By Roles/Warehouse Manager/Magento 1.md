...
![enter image description here](./image_%20Inventory%20M1/image001.png?raw=true) 

### For Warehouse Staff

![enter image description here](./image_%20Inventory%20M1/image003.png?raw=true) 
...
![enter image description here](./image_%20Inventory%20M1/image005.png?raw=true)
...
➢	**Step 1 + 2**: 
 ...
 ![enter image description here](./image_%20Inventory%20M1/image019.png?raw=true)

Fill the **Transfer Code**, choose **Source Warehouse** and **Destination Warehouse**

Fill in the **Reason** box

![enter image description here](./image_%20Inventory%20M1/image021.png?raw=true)

To prepare product list, click on the **Prepare Product List** button

 ![enter image description here](./image_%20Inventory%20M1/image023.png?raw=true)
...
Add new list (click on **Scan Barcode** to scan and choose products) or import a list of product prepared before ( click on **Import CSV file**)
 ...
 ![enter image description here](./image_%20Inventory%20M1/image025.png?raw=true)
1.	Click on the product needed 
2.	Choose the quantity to transfer
3.	Click on Start Sending
 ![enter image description here](./image_%20Inventory%20M1/image027.png?raw=true)

 ![enter image description here](./image_%20Inventory%20M1/image029.png?raw=true)
...
![enter image description here](./image_%20Inventory%20M1/image031.png?raw=true)
1. Mark the checkbok to select product(s).
2. Write the quantity received in receiving history 
3. Click on **Save Receiving**

 ![enter image description here](./image_%20Inventory%20M1/image033.png?raw=true)

Create receiving successfully

![enter image description here](./image_%20Inventory%20M1/image035.png?raw=true)
...
**Step 1+2:**
 ...
 ![enter image description here](./image_%20Inventory%20M1/image037.png?raw=true)
...
![enter image description here](./image_%20Inventory%20M1/image039.png?raw=true)

To prepare product list, click on the **Prepare Product List** button

 ![enter image description here](./image_%20Inventory%20M1/image041.png?raw=true)

Add new list (click on **Scan Barcode** to scan and choose products) or import a list of product prepared before ( click on **Import CSV file**)

![enter image description here](./image_%20Inventory%20M1/image043.png?raw=true)
...
3.	Click on **Start to request**
 ...
 ![enter image description here](./image_%20Inventory%20M1/image045.png?raw=true)
...
In Delivery History
  ...
  ![enter image description here](./image_%20Inventory%20M1/image047.png?raw=true)
...
3. Click on **Save Delivery**
 ...
 ![enter image description here](./image_%20Inventory%20M1/image049.png?raw=true)
...
Create delivery sucessfully
 ...
 ![enter image description here](./image_%20Inventory%20M1/image051.png?raw=true)
 
1. Click on the request created for receiving
2. Write the quantity received in receiving history
3. Click on **Save Receiving**

 ![enter image description here](./image_%20Inventory%20M1/image053.png?raw=true)
...
#### Check order information
 ...
 ![enter image description here](./image_%20Inventory%20M1/image055.png?raw=true)
...
When the refund order is accepted, follow this step to complete the refund process: 
 ...
 ![](./image_%20Inventory%20M1/image057.png?raw=true)
...
-  *Sales > Orders*
 ...
 ![](./image_%20Inventory%20M1/image063.png?raw=true) 
 
1. Click on **Create New Order** 

![](./image_%20Inventory%20M1/image065.png?raw=true)
 2. Click on a customer line to select a customer  
    
  ![](./image_%20Inventory%20M1/image067.png?raw=true)
...
![](./image_%20Inventory%20M1/image081.png?raw=true)
 
1. Click on **View** to see detailel information

 ![](./image_%20Inventory%20M1/image083.png?raw=true)
...
Pick and Pack Items are implemeted in offline. After those processes are done then the next step is to create shipment.
 ...
 ![](./image_%20Inventory%20M1/image089.png?raw=true)
1. Click on **Ship** tab

 ![](./image_%20Inventory%20M1/image091.png?raw=true)
 2.	**Add Tracking Number** to track the position of the order
 ![](./image_%20Inventory%20M1/image093.png?raw=true)
...
- *Path: Retailer Reports > Manage Reports > Product*
 ![](./image_%20Inventory%20M1/image097.png?raw=true)
...
![](./image_%20Inventory%20M1/image099.png?raw=true)
1. Click on **here** label to update the latest data before generating a report
...
![](./image_%20Inventory%20M1/image101.png?raw=true)
1. Click on **here** label to update the latest data before generating a report
...
![](./image_%20Inventory%20M1/image103.png?raw=true)
1. Click on **here** label to update the latest data before generating a report
...
![](./image_%20Inventory%20M1/image105.png?raw=true)
1. Click on **here** label to update the latest data before generating a report
...
![](./image_%20Inventory%20M1/image107.png?raw=true)
1. Click on **here** label to update the latest data before generating a report
...
- *Path: Retailer Reports > Manage Reports > Value of Stock on Hand*
 ![](./image_%20Inventory%20M1/image109.png?raw=true)
...
![](./image_%20Inventory%20M1/image111.png?raw=true) 
1. Choose the warehouse (one or all warehouses) before running report.
...
- *Path: Retailer Reports > Manage Reports > Compare by Warehouse*
 ![](./image_%20Inventory%20M1/image113.png?raw=true)
1. Choose the warehouse (one or all warehouses) before running report.
...
This report provides store owners details of incoming stock by each product SKU.
 ...
 ![](./image_%20Inventory%20M1/image115.png?raw=true)
...
- *Path: Retailer Reports > Manage Reports > Historical Inventory*
 ![](./image_%20Inventory%20M1/image117.png?raw=true)
...
![enter image description here](./image_%20Inventory%20M1/image119.png?raw=true)
...
➢	**Step 1 + 2**: 
 ...
 ![enter image description here](./image_%20Inventory%20M1/image133.png?raw=true)

Fill the **Transfer Code**, choose **Source Warehouse** and **Destination Warehouse**

Fill in the **Reason** box

![enter image description here](./image_%20Inventory%20M1/image135.png?raw=true)

To prepare product list, click on the **Prepare Product List** button

 ![enter image description here](./image_%20Inventory%20M1/image137.png?raw=true)

Add new list (click on **Scan Barcode** to scan and choose products) or import a list of product prepared before ( click on **Import CSV file**)

 ![enter image description here](./image_%20Inventory%20M1/image139.png?raw=true)
1.	Click on the product needed 
2.	Choose the quantity to transfer
3.	Click on Start Sending
 ![enter image description here](./image_%20Inventory%20M1/image141.png?raw=true)

 ![enter image description here](./image_%20Inventory%20M1/image143.png?raw=true)
...
![enter image description here](./image_%20Inventory%20M1/image145.png?raw=true)
1. Mark the checkbok to select product(s).
2. Write the quantity received in receiving history 
3. Click on **Save Receiving**

 ![enter image description here](./image_%20Inventory%20M1/image147.png?raw=true)

Create receiving successfully

![enter image description here](./image_%20Inventory%20M1/image149.png?raw=true)
...
**Step 1+2:**
 ...
 ![enter image description here](./image_%20Inventory%20M1/image151.png?raw=true)
...
![enter image description here](./image_%20Inventory%20M1/image153.png?raw=true)

To prepare product list, click on the **Prepare Product List** button

 ![enter image description here](./image_%20Inventory%20M1/image155.png?raw=true)

Add new list (click on **Scan Barcode** to scan and choose products) or import a list of product prepared before ( click on **Import CSV file**)

![enter image description here](./image_%20Inventory%20M1/image157.png?raw=true)
...
3.	Click on **Start to request**
 ...
 ![enter image description here](./image_%20Inventory%20M1/image159.png?raw=true)
...
In Delivery History
  ...
  ![enter image description here](./image_%20Inventory%20M1/image161.png?raw=true)

1.	Click on the request created for the transfer
2. Write the quantity deliveried in delivery history
3. Click on **Save Delivery**

 ![enter image description here](./image_%20Inventory%20M1/image163.png?raw=true)
...
Create delivery sucessfully
 ...
 ![enter image description here](./image_%20Inventory%20M1/image165.png?raw=true)
 
1. Click on the request created for receiving
2. Write the quantity received in receiving history
3. Click on **Save Receiving**

 ![enter image description here](./image_%20Inventory%20M1/image167.png?raw=true)
...
#### Check order information
 ...
 ![enter image description here](./image_%20Inventory%20M1/image169.png?raw=true)
...
When the refund order is accepted, follow this step to complete the refund process: 
 ...
 ![](./image_%20Inventory%20M1/image171.png?raw=truee)

 - **Step 2:** 
1. Select Warehouse where refund goods will be restored. 
2. Input the quality to refund.

 ![](./image_%20Inventory%20M1/image173.png?raw=true)

 - **Step 3**: End the refund offline process. Click on **Refund Offline.**

 ![](./image_%20Inventory%20M1/image175.png?raw=true)

### Goods Delivery
#### Create New Order 
-  *Sales > Orders*

 ![](./image_%20Inventory%20M1/image177.png?raw=true) 
 
1. Click on **Create New Order** 

![](./image_%20Inventory%20M1/image179.png?raw=true)
 2. Click on a customer line to select a customer  
    
  ![](./image_%20Inventory%20M1/image181.png?raw=true)
 3. Then select your store. Click on **Add Products** 
...
![](./image_%20Inventory%20M1/image195.png?raw=true)
 
1. Click on **View** to see detailel information

 ![](./image_%20Inventory%20M1/image197.png?raw=true)
...
Pick and Pack Items are implemeted in offline. After those processes are done then the next step is to create shipment.
 ...
 ![](./image_%20Inventory%20M1/image203.png?raw=true)
1. Click on **Ship** tab
