...
**Step 1+2:**
 ...
 ![enter image description here](./image_Inventory%20Management/image201.png?raw=true)

Fill the **Transfer Code,** choose **Source Warehouse** and **Destination Warehouse**

Fill in the **Reason** box

![enter image description here](./image_Inventory%20Management/image203.png?raw=true)

To prepare product list, click on the **Prepare Product List** button

 ![enter image description here](./image_Inventory%20Management/image205.png?raw=true)

Add new list (click on **Select Products**) or import a list of product prepared before ( click on **Import**)

![enter image description here](./image_Inventory%20Management/image207.png?raw=true)

To add new list of products, 
1. Click on the product needed 
2. **Add Selected Products**

 ![enter image description here](./image_Inventory%20Management/image209.png?raw=true)

3. Choose the quantity to transfer and click on **Start Request Stock**
4. Click on **Remove** to delete product line

 ![enter image description here](./image_Inventory%20Management/image211.png?raw=true)
...
**Step 3**: 
 ...
 ![enter image description here](./image_Inventory%20Management/image213.png?raw=true)

Click on **Select Products** in delivery history

![enter image description here](./image_Inventory%20Management/image215.png?raw=true)

1. Click on the request created for the transfer
2. **Add Selected Products**

 ![enter image description here](./image_Inventory%20Management/image217.png?raw=true)

Write the quantity deliveried in delivery history

  ![enter image description here](./image_Inventory%20Management/image219.png?raw=true)

Click on **Save Delivery**

![enter image description here](./image_Inventory%20Management/image221.png?raw=true)

Create delivery sucessfully

 - **RECEIVE STOCK**

 ![enter image description here](./image_Inventory%20Management/image223.png?raw=true)

Click on **Select Products** in receiving history

 ![enter image description here](./image_Inventory%20Management/image225.png?raw=true)

1. Click on the request created for receiving
2. Click on **Add Selected Products**

 ![enter image description here](./image_Inventory%20Management/image227.png?raw=true)

Write the quantity received in receiving history

 ![enter image description here](./image_Inventory%20Management/image229.png?raw=true)

Click on **Save Receive**

 ![enter image description here](./image_Inventory%20Management/image231.png?raw=true)

![enter image description here](./image_Inventory%20Management/image233.png?raw=true)
...
#### Check order information
 ...
 ![enter image description here](./image_Inventory%20Management/image235.png?raw=true)
...
When the refund order is accepted, follow this step to complete the refund process: 
 ...
 ![](./image_Inventory%20Management/image237.png?raw=true)

 - **Step 2:** 
   1. Select Warehouse where refund goods will be restored. 
   2. Input the quality to refund.

 ![](./image_Inventory%20Management/image239.png?raw=true)

 - **Step 3**: End the refund offline process.

 ![](./image_Inventory%20Management/image241.png?raw=true)
...
-  *Or Sales > Orders*
 ...
 ![](./image_Inventory%20Management/image243.png?raw=true) 

 1. Click on **Create New Order**
    
![](./image_Inventory%20Management/image245.png?raw=true)
    
 2.  Double click on a customer line to select a customer  
    
  ![](./image_Inventory%20Management/image247.png?raw=true)
 
 3. Click on **Add Products** 
 
 ![](./image_Inventory%20Management/image249.png?raw=true)
...
![](./image_Inventory%20Management/image251.png?raw=true)

8. Mark the checkbox **Custom Price** to customize a price 
9. Mark the checkbox to **Apply discount** (if any)
10. **Apply coupon code** and **Use gift card to checkout** 

 ![](./image_Inventory%20Management/image253.png?raw=true)
 
11. Select a **shipping method**

 ![](./image_Inventory%20Management/image255.png?raw=true)
...
#### Verify Orders
 ...
 ![](./image_Inventory%20Management/image257.png?raw=true)

1. Click on **Process Verify** to verify the order

 ![](./image_Inventory%20Management/image259.png?raw=true)

2. Click on **Mark as Verified**, then the order has been verified successfully

#### Prepare Fulfil

 ![](./image_Inventory%20Management/image261.png?raw=true)

1. Click on tab **Prepare Fulfill** on the top sidebar
2. Click on Fulfill

 ![](./image_Inventory%20Management/image263.png?raw=true)
...
4. Click on **Add products** to request
 ...
 ![](./image_Inventory%20Management/image265.png?raw=true)
...
#### Pick Items
 ...
 ![](./image_Inventory%20Management/image267.png?raw=true)
 
1. Click on tab **Pick Items** on the top sidebar
2. Click on **View Details**

 ![](./image_Inventory%20Management/image269.png?raw=true)
...
4. Enter the **picked quantity**
 ...
 ![](./image_Inventory%20Management/image271.png?raw=true)
...
#### Pack Items 
 ...
 ![](./image_Inventory%20Management/image275.png?raw=true)
...
Your recently package will be displayed as below
 ...
 ![](./image_Inventory%20Management/image281.png?raw=true)
...
#### Invoices
 ...
 ![](./image_Inventory%20Management/image283.png?raw=true)
 
1. Click on **View** to see detailel information

 ![](./image_Inventory%20Management/image285.png?raw=true)
 
2. Click on **Invoice** tabs 

 ![](./image_Inventory%20Management/image287.png?raw=true)
...
4. Click on **Update Qty’s** if there is any changes in quantities
 ...
 ![](./image_Inventory%20Management/image289.png?raw=true)
...
-	*Path: Sales > Orders* 
 ...
 ![](./image_Inventory%20Management/image291.png?raw=true)

Click on “**Create new order**” in sales

 ![](./image_Inventory%20Management/image293.png?raw=true)

Click on the customers chosen to make new orders

 ![](./image_Inventory%20Management/image295.png?raw=true)

Click on **Add Products** to choose products for the sale order

 ![](./image_Inventory%20Management/image297.png?raw=true)

Choose the products to sell and set the quantity in the **Select** and **Quantity** column, after that, click on **Add Selected Product(S) Order**

 ![](./image_Inventory%20Management/image299.png?raw=true)

Choose the rate in the shipping method

![](./image_Inventory%20Management/image301.png?raw=true)

Click on **Submit Order** to submit order

 ![](./image_Inventory%20Management/image303.png?raw=true)

Click on **Mark As Verified**

![](./image_Inventory%20Management/image305.png?raw=true)

Click on **Fulfill** to continue the process

 ![](./image_Inventory%20Management/image307.png?raw=true)
 
1. Click on **Request Dropship**
2. Click on **Add Products To Request**

 ![](./image_Inventory%20Management/image309.png?raw=true)
...
![](./image_Inventory%20Management/image311.png?raw=true)

As being instructed in the email, the supplier follows the login link to access the **Supplier Manager** page and then fills in the Qty. that he can ship.

**Note:** When adding/ editing a supplier, the **Password Management** section will be shown. You can set password and email it to the supplier. The email will be shown as below:

 ![](./image_Inventory%20Management/image313.png?raw=true)

In case the supplier forget the password, the can request to reset the password. After the request is send, the supplier will receive a notification email as below:

 ![](./image_Inventory%20Management/image315.png?raw=true)
...
If the supplier can’t meet your demand, they would refuse to create shipment. You will receive a notification email as below:
 ...
 ![](./image_Inventory%20Management/image317.png?raw=true)

-  **If the item is available in stock -> Creates Shipments -> Ships items to customers and confirm the shipped Qty after shipping.** 

The supplier need to enter the carrier information and shipped Qty to create shipment. After a supplier create shipment, you will receive a notification email as below:            

 ![](./image_Inventory%20Management/image319.png?raw=true)
