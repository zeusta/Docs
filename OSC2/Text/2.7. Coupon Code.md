...
![customers can enter coupon code on checkout page](https://raw.githubusercontent.com/Magestore/docs/master/OSC2/Image/How-to-use/osc2-use-15.png)

After Customers apply coupon code, the **Estimated Total** will be updated as below:

![Estimated Total is updated accordingly on page when coupon code is used](https://raw.githubusercontent.com/Magestore/docs/master/OSC2/Image/How-to-use/osc2-use-16.png)
