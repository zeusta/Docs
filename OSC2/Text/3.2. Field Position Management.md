...
![Store owner can enable/disable or rearrange fields in Billing and Shipping Address sections](https://raw.githubusercontent.com/Magestore/docs/master/OSC2/Image/How-to-config/1-config.png)
...
![Store owners can configure multiple stores differently](https://raw.githubusercontent.com/Magestore/docs/master/OSC2/Image/How-to-config/4-config.png)
![Store owners choose Store View to config for a specific store](https://raw.githubusercontent.com/Magestore/docs/master/OSC2/Image/How-to-config/5-config.png)

After you configure in backend, the Checkout page will be shown in frontend as below:
* Default store:
![Default store's frontend is updated according to backend changes](https://raw.githubusercontent.com/Magestore/docs/master/OSC2/Image/How-to-config/6-config.png)

* Second store:
![Second store's frontend is updated according to backend changes](https://raw.githubusercontent.com/Magestore/docs/master/OSC2/Image/How-to-config/7-config.png)
